...
public class Main {
    public static void main(String[] args) {
        ...
        CompruebaDatosDB.setup("create table facturas (id int,cliente varchar(40))");
        CompruebaDatosDB.setup("create table lineas (id int,descripcion varchar(40),factura_id int)");
