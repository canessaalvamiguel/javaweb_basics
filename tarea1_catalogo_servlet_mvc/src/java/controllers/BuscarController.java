 ...
 */
@WebServlet(name = "BuscarController", urlPatterns = {"/catalogo/buscar"})
public class BuscarController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Producto producto = modelo.buscarPorNombre(nombre);
        ...
        if(producto != null){
            ...
            request.setAttribute("titulo", "Producto NO existe");
        }
